...
const STRINGS = {
  en: {
    ...
    video_cap: "Watch the 2 minute setup: install the app, then turn on a connector.",
  ...
  vi: {
    ...
    video_cap: "Xem hướng dẫn cài đặt 2 phút: cài ứng dụng, rồi bật một trình kết nối.",
